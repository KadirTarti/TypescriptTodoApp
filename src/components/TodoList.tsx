...
const TodoList: FC<ITodoList> = ({ todos, toggleTodo, deleteTodo }) => {
  ...
  return (
    <Grid container sx={{
      ...
      >
        <Typography className='title' color="secondary" fontWeight={'bold'} align="center" variant="h5">
          InProgress Todos
        </Typography>
        {progressTodos.length ? (
          ...
          <Typography color="white" fontSize={'20px'} textAlign={'center'} mt={3}>
            No Progress Todos!
          </Typography>
        )}
      </Grid>
      ...
      >
        <Typography className="title" sx={{color:"green",}}  fontWeight={'bold'} align="center" variant="h5">
          Completed Todos
        </Typography>
